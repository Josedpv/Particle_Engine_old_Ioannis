...
//const THREE = require('three/src/Three.js');
/////////////
// SHADERS //
/////////////
...
class ParticleEngine
{
	...
	constructor() {
		...
		this.particleGeometry.setAttribute('position', new THREE.BufferAttribute(new Vector3(), 3));
		this.particleGeometry.setAttribute('customVisible', new THREE.BufferAttribute(this.customVisible, 1));
		this.particleGeometry.setAttribute('customAngle', new THREE.BufferAttribute(this.customAngle, 1));
		this.particleGeometry.setAttribute('customSize', new THREE.BufferAttribute(this.customSize, 1));
		this.particleGeometry.setAttribute('customColor', new THREE.BufferAttribute(this.customColor, 3));
		this.particleGeometry.setAttribute('customOpacity', new THREE.BufferAttribute(this.customOpacity, 1));
		/*
		this.particleGeometry.setAttribute('position', new BufferAttribute(new Float32Array(this.particleCount), 3));
		this.particleGeometry.setAttribute('customVisible', new BufferAttribute(new Float32Array(this.particleCount), 1));
		this.particleGeometry.setAttribute('customAngle', new BufferAttribute(new Float32Array(this.particleCount), 1));
		this.particleGeometry.setAttribute('customSize', new BufferAttribute(new Float32Array(this.particleCount), 1));
		this.particleGeometry.setAttribute('customColor', new BufferAttribute(new Float32Array(this.particleCount), 3));
		this.particleGeometry.setAttribute('customOpacity', new BufferAttribute(new Float32Array(this.particleCount), 1));
		/*
...
ParticleEngine.prototype.setValues = function( parameters )
{
	...
	this.particleMesh = new Points();// Point
}
...
this.customOpacity.value[i]=  this.particleArray[i].opacity;
		...
		this.particleGeometry.setAttribute('position'+ i,new THREE.BufferAttribute(this.particleArray[i].position,3));
	
		this.particleGeometry.setAttribute('position'+i, new THREE.BufferAttribute(this.customVisible.value[i], 3));
		this.particleGeometry.setAttribute('customVisible'+i, new THREE.BufferAttribute(this.customVisible.value[i], 1));
		this.particleGeometry.setAttribute('customAngle'+i, new THREE.BufferAttribute(this.customAngle.value[i], 1));
		this.particleGeometry.setAttribute('customSize'+i, new THREE.BufferAttribute(this.customSize.value[i], 1));
		this.particleGeometry.setAttribute('customColor'+i, new THREE.BufferAttribute(this.customColor.value[i], 3));
		this.particleGeometry.setAttribute('customOpacity'+i, new THREE.BufferAttribute(this.customOpacity.value[i], 1));
...
var Examples =
{
	...
	smoke :
	{
		...
		particleTexture : new THREE.TextureLoader.prototype.load( 'images/smokeparticle.png'),
